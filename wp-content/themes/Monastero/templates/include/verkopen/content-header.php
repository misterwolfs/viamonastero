          ...
          <div class="language-contact">
            <div class="inner-wrapper">
              ...
              <ul class="language-selection">
                                <li><a href="/nl/?p=976" title="Nederlands" <?php if(ICL_LANGUAGE_CODE == 'nl') : ?>class="active" <?php endif ?>>NL</a></li>
                <li><a href="/fr/?p=984" title="Français" <?php if(ICL_LANGUAGE_CODE == 'fr' ): ?>class="active" <?php endif ?>>FR</a></li>
                <li><a href="/en/?p=983" title="Englisch" <?php if(ICL_LANGUAGE_CODE == 'en') : ?>class="active" <?php endif ?>>ENG</a></li>
