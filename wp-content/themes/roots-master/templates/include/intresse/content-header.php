          ...
          <div class="language-contact">
            <div class="inner-wrapper">
              ...
              <ul class="language-selection">
                                <li><a href="<?= get_site_url(); ?>/?p=974" title="Nederlands" <?php if($lang == 'nl') : ?>class="active" <?php endif ?>>NL</a></li>
                <li><a href="<?= get_site_url(); ?>/fr/?p=979" title="Français" <?php if($lang == 'fr' ): ?>class="active" <?php endif ?>>FR</a></li>
                <li><a href="<?= get_site_url(); ?>/en/?p=978" title="Englisch" <?php if($lang == 'en') : ?>class="active" <?php endif ?>>ENG</a></li>

              </ul>

              <!--Contact icons-->
              <ul class="contact-icons">
                                <li class="telephone"><a href="#" title="Telefoneer ons"><img src="<?= content_url( 'themes/roots-master/assets/img/telephone@2x.png'); ?>" alt="Via Monastero" width="20" height="20" /></a>
